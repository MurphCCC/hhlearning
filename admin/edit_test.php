...
$c7feedback = mysql_real_escape_string($c7feedback);
 ...
 $result = mysql_query("UPDATE `students_test` SET `C1TEACHER` = \"$c1teacher\", `C1COURSE` = \"$c1course\", `C1GRADE` = \"$c1grade\", `C1FEEDBACK` = \"$c1feedback\" WHERE `ID` = '". $id . "'") 

      or die("Couldn't update student's Class 1 Record.");



 $result = mysql_query("SELECT * FROM `students_test` WHERE ID = '" . $id . "'")
...
if ($line['C2COURSE'] != NUll) :
 ...
 $result = mysql_query("UPDATE `students_test` SET `C2TEACHER` = \"$c2teacher\", `C2COURSE` = \"$c2course\", `C2GRADE` = \"$c2grade\", `C2FEEDBACK` = \"$c2feedback\" WHERE `ID` = '" . $id . "'") 
...
if ($line['C3COURSE'] != NUll) :
 ...
 $result = mysql_query("UPDATE `students_test` SET `C3TEACHER` = \"$c3teacher\", `C3COURSE` = \"$c3course\", `C3GRADE` = \"$c3grade\", `C3FEEDBACK` = \"$c3feedback\" WHERE `ID` = '" . $id . "'") 
...
if ($line['C4COURSE'] != NUll) :
 ...
 $result = mysql_query("UPDATE `students_test` SET `C4TEACHER` = \"$c4teacher\", `C4COURSE` = \"$c4course\", `C4GRADE` = \"$c4grade\", `C4FEEDBACK` = \"$c4feedback\" WHERE `ID` = '" . $id . "'") 
...
if ($line['C5COURSE'] != NUll) :
 ...
 $result = mysql_query("UPDATE `students_test` SET `C5TEACHER` = \"$c5teacher\", `C5COURSE` = \"$c5course\", `C5GRADE` = \"$c5grade\", `C5FEEDBACK` = \"$c5feedback\" WHERE `ID` = '" . $id . "'") 
...
if ($line['C6COURSE'] != NUll) :
 ...
 $result = mysql_query("UPDATE `students_test` SET `C6TEACHER` = \"$c6teacher\", `C6COURSE` = \"$c6course\", `C6GRADE` = \"$c6grade\", `C6FEEDBACK` = \"$c6feedback\" WHERE `ID` = '" . $id . "'") 
...
if ($line['C7COURSE'] != NUll) :
 ...
 $result = mysql_query("UPDATE `students_test` SET `C7TEACHER` = \"$c7teacher\", `C7COURSE` = \"$c7course\", `C7GRADE` = \"$c7grade\", `C7FEEDBACK` = \"$c7feedback\" WHERE `ID` = '" . $id . "'") 
...
$result = mysql_query("select * from `students_test`");
