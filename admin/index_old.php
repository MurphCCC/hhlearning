  ...
  <tr>
    <td width="100%"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          ...
          <td><font size="4" face="Garamond"><strong> Administrator Login Page</strong></font></td>
        </tr>
        <tr> 
        ...
        <tr>
          ...
          <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                <td valign="top"width="250" height="25"><a href=add.php><font size="3" face="Garamond">Add 
                  a Student</font></a></td>
                <td></td>
              </tr>
              <tr> 
                <td valign="top"width="250"height="25"><a href=delete.php><font size="3" face="Garamond">Delete 
                  a Student</font></a></td>
                <td></td>
              </tr>
              <tr> 
                <td valign="top"width="250"height="25"><a href=edit.php><font size="3" face="Garamond">Edit 
                  a Grade Sheet</font></a></td>
                <td></td>
              </tr>
              <tr> 
                <td valign="top"width="250"height="25"><a href=reset.php><font size="3" face="Garamond">Reset 
                  the Semester</font></a></td>
                <td></td>
              </tr>
              <tr> 
                <td valign="top"width="250"height="25"><a href=print.php><font size="4" face="Garamond">Print 
                  a Grade Sheet</font></a></td>
                <td></td>
              </tr>
            </table>
