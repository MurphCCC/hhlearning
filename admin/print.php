  ...
  <tr>
    <td width="100%"> <p>&nbsp;</p>
      <p><strong><b><?PHP print $line['FIRSTNAME'] . $line['LASTNAME'];?></b></strong> has 
        received the following  percentage grade(s) for one semester of class(es) administered 
      ...
      <p><table width=550><tr><td><?PHP print htmlspecialchars($line['C1FEEDBACK'], ENT_QUOTES);?></td></tr></table></p>
...
<?PHP if ($line['C2COURSE'] != NULL) :?>
      ...
      <p><table width=550><tr><td><?PHP print htmlspecialchars($line['C2FEEDBACK'], ENT_QUOTES);?></td></tr></table></p>
<?PHP endif;?>
...
<?PHP if ($line['C3COURSE'] != NULL) :?>
      ...
      <p><table width=550><tr><td><?PHP print htmlspecialchars($line['C3FEEDBACK'], ENT_QUOTES);?></td></tr></table></p>
<?PHP endif;?>
...
<?PHP if ($line['C4COURSE'] != NULL) :?>
      ...
      <p><table width=550><tr><td><?PHP print htmlspecialchars($line['C4FEEDBACK'], ENT_QUOTES) ;?></td></tr></table></p>
<?PHP endif;?>
...
<?PHP if ($line['C5COURSE'] != NULL) :?>
      ...
      <p><table width=550><tr><td><?PHP print htmlspecialchars($line['C5FEEDBACK'], ENT_QUOTES) ;?></td></tr></table></p>
<?PHP endif;?>
...
<?PHP if ($line['C6COURSE'] != NULL) :?>
      ...
      <p><table width=550><tr><td><?PHP print htmlspecialchars($line['C6FEEDBACK'], ENT_QUOTES) ;?></td></tr></table></p>
<?PHP endif;?>
...
<?PHP if ($line['C7COURSE'] != NULL) :?>
      ...
      <p><table width=550><tr><td><?PHP print htmlspecialchars($line['C7FEEDBACK'], ENT_QUOTES) ;?></td></tr></table></p>
<?PHP endif;?>
...
<?PHP 
 if ($resultnum<$maxnum-1) :
  ...
  print "<form name='form1' method='post' action='" . $PHP_SELF . "'>
	...
	<input type='image' src='trans.gif' alt='Next'>
  ...
  <tr>
    <td width="100%"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr> 
          ...
          <td><form name="form1" method="post" target="_blank" action="print_student_report.php">
...
?> 
        ...
        <tr> 
          <td bgcolor="#FFFFFF">&nbsp;</td>
          <td><font size="4" face="Garamond"><strong> 
		     <em>Print All Grade Sheets</em></strong></font></td>
        </tr>
        <tr> 
          <td bgcolor="#FFFFFF">&nbsp;</td>
          <td> <form name="print_all" method="post" action="print_all.php" target="_blank">
		       <input type="submit" name="view_all" value="Print All">
		  </form>
            </td>
        </tr>
      </table>
