            ...
            foreach ($student as $row) {
                ...
                $pdf->Ln(5);
                    while ($i <= 7) {
                        ...
                        $next_course = $i + 1;
                        // echo $next_course;
                        if (!empty($row[$i.'_course'])) {                
                            $pdf->SetFont('Times','B',10);
                            $pdf->Cell(10);
                            $course = "Course: " . $row[$i.'_course'];
                            ...
                            $pdf->Cell(10);
                            $teacher = "Instructor: " . $row[$i.'_teacher'];
                            ...
                            $pdf->Ln(10);
                             if (empty($row[$next_course.'_course'])) {
