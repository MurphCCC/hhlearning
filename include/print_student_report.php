...
$pdf = new PDF();
     ...
     $statement->execute(array(':student_id' => 536));
...
if ($list) {
	...
	while ($row = $list) {
		...
		$pdf->Cell(10);
		$course1 = "Course: " . $row['c1_course'];
		$pdf->Cell(0,5,$course1,0,1,'L');
		
		$pdf->Ln(1);
		
		$pdf->Cell(10);
		$grade1 = "Grade: " . $row['c1_grade'];
		$pdf->Cell(0,5,$grade1,0,1,'L');
		
		$pdf->Ln(1);
		
		$pdf->Cell(10);
		$teacher1 = "Instructor: " . $row['c1_teacher'];
		...
		$pdf->SetFont('Times','',10);
		$pdf->Cell(10);
		$feedback1 = trim($row['c1_feedback']);
		...
		if ($row['c2_course']) {
			...
			$pdf->Cell(10);
			$course2 = "Course: " . $row['c2_course'];
			$pdf->Cell(0,5,$course2,0,1,'L');
			
			$pdf->Ln(1);
			
			$pdf->Cell(10);
			$grade2 = "Grade: " . $row['c2_grade'];
			$pdf->Cell(0,5,$grade2,0,1,'L');
			
			$pdf->Ln(1);
			
			$pdf->Cell(10);
			$teacher2 = "Instructor: " . $row['c2_teacher'];
